...
| :---------- | :--------------------------------------------------------------------------------------------------------------------------------------------------- | :---------------------------------------------------------------- | ---- | ---------------------------------------------------------------------------------------------------------------------------------------- |
| 概述        | [安全多方计算学习路线](https://zhuanlan.zhihu.com/p/351492646)                                                                                       | [六三 @知乎](https://www.zhihu.com/people/an-quan-xiao-qi)        | 2021 | “SMPC的构造大体分为以下流派：①GC（混淆电路）②SPDZ（算数电路）（基于SS和SHE）③GMW（布尔电路）④ABY（算数、布尔、混淆电路的share转换）⑤FHE” |
